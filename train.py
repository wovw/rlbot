# Train our agent! # Here we import the Match object and our multi-instance wrapper
...
def get_match():
    # Here we configure our Match. If you want to use custom configuration objects,
...
if __name__ == "__main__":
    ...
    """
    env = SB3MultipleInstanceEnv(match_func_or_matches=get_match, num_instances=2, wait_time=60)
